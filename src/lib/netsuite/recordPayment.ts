// src/lib/netsuite/recordPayment.ts
...
export async function recordPaymentForInvoice(
  ...
  // Try transform (auto-applies to the specific invoice)
  try {
  ...
  // Fallback: create payment, then PATCH the specific apply row for this invoice
